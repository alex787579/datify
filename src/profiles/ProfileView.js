...
import { ref, listAll, uploadBytesResumable, getDownloadURL } from "firebase/storage"; // Import necessary functions
...
const ProfileView = () => {
  ...
  //   "img/user.jpg",
  //   "imageuser/pexels-breno-cardoso-149064345-24461279.jpg",
  //   "imageuser/pexels-hatice-baran-153179658-28003084.jpg",
  //   "imageuser/a207f0249ccb2155eecd0b119f13669c-1489662071.jpg",
  // ];
      ...
      <div className="content">
        ...
        {images.length > 0 ? (
          ...
          />
                      ...
                      <div className="profile-placeholder text-center" onClick={() => setShowProfileModal(true)}>
                      ...
                      <div className="card shadow-sm">
                        <div className="card-body">
                            ...
                            <div className="m-n2">
                              {selectedInterests.map((interestId) => (
                                <button
                                  key={interestId}
                                  className={`btn btn-${
                                    interestColors[interestId] || "light"
                                  } m-2`}
                                >
                                  {
                                    allInterests.find(
                          ...
                          <div className="additional-info mt-4">
                            ...
                            <p>{profession || "IT / Software Professional"}</p>
                ...
                <div className={`modal fade ${showProfileModal ? "show" : ""}`} style={{ display: showProfileModal ? "block" : "none" }} id="profileModal" tabIndex="-1" role="dialog" aria-labelledby="profileModalLabel" aria-hidden={!showProfileModal}>
                  <div className="modal-dialog modal-dialog-scrollable" role="document">
                    <div className="modal-content">
                      <div className="modal-header">
                        <h5 className="modal-title" id="profileModalLabel">Profile Upload</h5>
                        ...
                        <div className="selected-files">
                          {selectedFiles.map((file, index) => (
                            <div key={index} className="file-item">
                              <span>{file.name}</span>
                              <button className="remove-button" onClick={() => handleFileRemove(file)}>Remove</button>
                            </div>
                          ))}
                        </div>
                        {totalFiles > 0 && (
                          <div className="progress-bar">
                            <div className="progress" style={{ width: `${uploadProgress}%` }}>
                              {uploadProgress}% {uploadProgress === 100 && " - Completed!"}
                            </div>
                          </div>
                        )}
                      </div>
                      <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-primary" onClick={handleUpload}>Save</button>
                      </div>
                    </div>
                  </div>
                </div>
